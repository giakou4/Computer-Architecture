...
```
./build/ARM/gem5.opt -d spec_results/spechmmer configs/example/se.py --cpu-
type=MinorCPU --caches --l2cache -c spec_cpu2006/456.hmmer/src/spechmmer -o "--
...
#### Runnning benchmark with more parameters
